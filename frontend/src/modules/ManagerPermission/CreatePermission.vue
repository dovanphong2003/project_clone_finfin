<template>
  ...
  <CptModalCenter title="Tạo thêm quyền hạn" :show="showModal" :handleShowFalse="handleShowFalse">
    <ModalCreatePermission> </ModalCreatePermission>
  </CptModalCenter>
</template>
<script setup lang="ts">
import CptModalCenter from '@/common/components/CptModalCenter.vue'
import ModalCreatePermission from './Modals/ModalCreatePermission.vue'
import { ref } from 'vue'
